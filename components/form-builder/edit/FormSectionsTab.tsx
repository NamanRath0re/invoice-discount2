...
//   // Local sub-sections map: parent_step_id -> SubSection[]
//   // Since there's no GET API yet, we manage added sub-sections in local state
...
//       parent_step_id:  String(sub.parent_step_id),
//     });
//     router.push(`${pathname}?${params.toString()}`);
//   };
...
//       ...prev,
//       [newSub.parent_step_id]: [
//         ...(prev[newSub.parent_step_id] ?? []),
//         newSub,
//       ],
//     }));
//   };
...
//               key={step.step_key}
//               step={step}
//               subSections={subSectionsMap[step.parent_step_id] ?? []}
...
//           formId={Number(formId)}
//           parentStepId={subModalState.parentStep.parent_step_id}
//           parentStepName={subModalState.parentStep.step_name}
//           existingSubSections={subSectionsMap[subModalState.parentStep.parent_step_id] ?? []}
