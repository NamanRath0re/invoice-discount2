...
//   step_order: number;
//   rendered_json: { fields: FieldDef[] };
//   sub_steps?: ApiSubStep[]; // ← server sends "sub_steps"
// }
...
// function normaliseStep(raw: ApiStep): Step {
//   return {
//     step_key: raw.step_key,
//     step_name: raw.step_name,
//     step_order: raw.step_order,
//     rendered_json: raw.rendered_json?.fields ?? [],
//     // Map sub_steps → sub_sections with consistent field names
//     sub_sections: (raw.sub_steps ?? []).map((s) => ({
//       id: s.id,
...
//   const raw: ApiStep[] = json.data?.steps ?? [];
//   return raw
//     .map(normaliseStep)
...
//             <div key={field.key} className={`col-span-12 sm:col-span-${field.grid_width ?? 6}`}>
//               <PreviewField field={field} value={values[field.key]} onChange={handleChange} />
//             </div>
//           ))}
//         </div>
...
//         <div className="flex items-center gap-1 pb-2 w-120">
...
//     step_name: raw.step_name,
//     step_order: raw.step_order,
//     rendered_json: raw.rendered_json ?? [],
//     // Map sub_steps → sub_sections with consistent field names
//     sub_sections: (raw.sub_steps ?? []).map((s) => ({
//       id: s.id,
//       sub_section_key: s.step_key,
